...
#### Functions
# Functions to trigger traps mentioned on the top
function foundsecret {
	stty sane
	clear
	dialog --msgbox "You found out the secret of getting-out of the script." 7 60
	stty sane
    clear
	exit
    }
function reset {
	dialog --msgbox "You are not allowed to kill the process" 7 60
	clear
